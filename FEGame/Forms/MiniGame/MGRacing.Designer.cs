...
namespace FEGame.Forms.MiniGame
{
    partial class MGRacing
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.colorLabel1.Text = "|这是一个vsAI玩家的|#ff0000|赛马游戏||。游戏由|#ff0000|15||个回合构成。每回合选择不同的骑行速度。赛道分成|#cc6600|简单、中等" +
    "和困难||三种。高速可以用帮助你领先，但在高难度赛道可能更容易引起事故并落后。使用|#0066ff|氮气||虽然可以获得高速，但总是特别危险。|n|最终得分=|" +
    "#ffcc00|领先的距离||。";
            // 
            // bitmapButtonC1
            // 
